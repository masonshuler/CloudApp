...
=======
    ...
    PRIMARY KEY (id),
    is_admin BIT NOT NULL
>>>>>>> 962ffcad05cc2aeaa8158bd3afffb02ca4f7a221
);
...
=======
('Polka Dot Slim Fit Dress Shirt', 129.00, 5.00, 'T-Shirt', 'M', 'Material is cotton/silk, slim fit.', '2018-04-18'),
('Diesel Brothers Shirt', 16.98, 5.00, 'T-Shirt', 'S', 'Shirt with orange and skull logo from diesel brothers', '2018-04-18'),
('Aston Martin Racing Shirt', 44.99, 5.00, 'T-Shirt', 'L', 'Black shirt with logos', '2018-04-18'),
('PK Subban Playoff Hockey Shirt', 19.99, 5.00, 'T-Shirt', 'L', 'Black shirt with small hockey logo in the middle', '2018-04-18'),
>>>>>>> 962ffcad05cc2aeaa8158bd3afffb02ca4f7a221
...
=======
('Hooded Color Block Corduroy Jacket', 39.99, 5.00, 'Jacket', 'XXXL', 'Multi-colored coat with green base and yellow/red accents', '2018-04-18');
>>>>>>> 962ffcad05cc2aeaa8158bd3afffb02ca4f7a221
