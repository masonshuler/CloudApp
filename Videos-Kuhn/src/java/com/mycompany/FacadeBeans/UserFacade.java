...
public class UserFacade extends AbstractFacade<User> {
    ...
    /*
    ----------------------------------------------------------------------------------------------------
    Annotating 'private EntityManager em;' with '@PersistenceContext(unitName = "UsersVideos-JordanPU")' 
    implies that the EntityManager instance pointed to by 'em' is associated with the 'UsersVideos-JordanPU'
     ...
     */
    /**
     * @param id is the Primary Key of the User entity in a table row in the UsersVideosDB database.
