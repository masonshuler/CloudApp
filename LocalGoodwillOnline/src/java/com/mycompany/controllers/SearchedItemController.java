...
@Named("searchedItemController")
@SessionScoped
public class SearchedItemController implements Serializable {
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SearchedItemController controller = (SearchedItemController) facesContext.getApplication().getELResolver().
